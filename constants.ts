...
export const PERSONA_CONFIG = {
  [Persona.Yashwanth]: {
    ...
    avatar: "🚀",
    tagline: "Backend Engineer → Full-Stack & Mobile Dev Journey",
    description:
...
export const SAMPLE_QUESTIONS = [
  "What’s the 20% of TypeScript I need to know for NestJS?",
  ...
  "What’s the roadmap to transition into full-stack mobile development?",
  "How do I learn DevOps essentials as a backend developer?",
  "How do I use React Query effectively in projects?",
  "What’s the best way to master SQL for backend interviews?",
